...
PATTERN_PARAMETERS = [
    ...
    # Section: SingleSkin
    ("include_buerzl", True,
     ("Inclure le buerzl (bord d'attaque SingleSkin)",
      "Include buerzl (SingleSkin leading edge)"),
     bool, None),
]
...
_STRINGS = {
    ...
    "preview_btn":    ("Prévisualiser", "Preview"),
}
...
class PatternConfigDialog(QtGui.QDialog):
    ...
    def __init__(self, parent=None, config=None, glider_obj=None):
        ...
        # Store config and glider object
        self.input_config = config or {}
        self.glider_obj = glider_obj
    ...
    def _setup_ui(self):
        ...
        self.preview_btn = QtGui.QPushButton()
    ...
    def _apply_language(self):
        ...
        self.preview_btn.setText(_STRINGS["preview_btn"][lang])
...
def show_pattern_config_dialog(parent=None, current_config=None, glider_obj=None):
    ...
    Args:
        ...
        glider_obj: FreeCAD glider object (for preview)
