...
class AirfoilControlTool(BaseTool):
    ...
    def setup_pivy(self):
        ...
        self.task_separator.addChild(self.dist_grid)
        self.task_separator.addChild(self.dist_coords)
        self.task_separator.addChild(self.thickness_grid)
        self.task_separator.addChild(self.thickness_coords)
    ...
    def _setup_distribution_spline(self):
        ...
        self.task_separator.addChild(self.dist_controlpoints)
        self.task_separator.addChild(self.dist_curve.object)
    ...
    def _setup_thickness_spline(self):
        ...
        self.task_separator.addChild(self.thickness_controlpoints)
        self.task_separator.addChild(self.thickness_curve_line.object)
    ...
    def _update_thickness_grid(self):
        ...
        trans = coin.SoTranslation()
        trans.translation = (-2.0, 1.0 + y_offset, 0.001)
        text = coin.SoText2()
