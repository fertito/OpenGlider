...
if plotpart_left is not None:
    print(f"Left PlotPart: {len(plotpart_left.cuts)} cuts, {len(plotpart_left.marks)} marks")
if plotpart_right is not None:
    print(f"Right PlotPart: {len(plotpart_right.cuts)} cuts, {len(plotpart_right.marks)} marks")
